...
def main()->None:
 ...
 if coverage==0:
  ...
  output["warning"].update(score=None,raw_score=None,concurrence_bonus=None,status="UNAVAILABLE",headline="No source-backed procurement warning score is available.")
