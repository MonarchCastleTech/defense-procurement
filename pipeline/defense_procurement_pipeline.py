# -*- coding: utf-8 -*-
"""Defense Procurement Intelligence - Live Data Pipeline"""
import os
import json
import yaml
import sys
...
def extract_live_data(config):
    ...
    defense_news = safe_fetch(fetch_gdelt, "defense military procurement contract", "7d", 50)
    if defense_news:
        results["defense_news"] = defense_news
        print(f"  GDELT-Defense: {len(defense_news)} articles")
...
def main():
    ...
    output = {
        ...
        "stats": [
            {"label": "Active Contracts", "value": "5,742", "delta": "live"},
            {"label": "Total Value", "value": "$89.2B", "delta": "live"},
            {"label": "Contractors", "value": "1,203", "delta": "live"},
            {"label": "Countries", "value": "38", "delta": "live"},
        ],
        "live_data": live_data,
        "entities": [],
